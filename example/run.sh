...
#python3 test-w-generator.py --config=networks.xml --scope-name=scope0 --generator-name=generator0 --generator-amplitude=10.00 --scope-channel-name="ch1" --scope-channel-range=4.0 --generator-channel-name="default" --samples=64000 --sample-rate=40000 --scope-trigger-source=ch2 --scope-trigger-level=1.4 --scope-trigger-slope=negative --scope-channel-parameters=" " --start-frequency=1595.00 --stop-frequency=1610.00 --sweep-time=1.0
python3 test-w-generator.py --config=networks.xml --scope-name=scope0 --generator-name=generator0 --generator-amplitude=10.00 --scope-channel-name="ch1" --scope-channel-range=4.0 --generator-channel-name="default" --samples=64000 --sample-rate=40000 --scope-trigger-source=ch2 --scope-trigger-level=1.4 --scope-trigger-slope=negative --scope-channel-parameters=" " --start-frequency=1580.00 --stop-frequency=1610.00 --sweep-time=1.0 | tee report/${directory}/log.txt
